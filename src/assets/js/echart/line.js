...
const line = function (id, params) {
    ...
    let config = {
        ...
        yAxis: [
            {
                title: params.yAxis[0].title || '', // y轴标题
                splitNumber: params.yAxis[0].splitNumber || 3, // 坐标轴的分割段数
                suffix: params.yAxis[0].suffix || '' // 刻度标签的内容格式
            },
            {
                title: params.yAxis[1].title || '', // y轴标题
                splitNumber: params.yAxis[1].splitNumber || 3, // 坐标轴的分割段数
                suffix: params.yAxis[1].suffix || '' // 刻度标签的内容格式
            }
        ]
    };
        ...
        yAxis: [
            {
                ...
                // y轴标题
                name: config.yAxis[0].title,

                // 坐标轴的分割段数
                splitNumber: config.yAxis[0].splitNumber,
                ...
                // 坐标轴刻度标签的相关设置
                axisLabel: {
                    formatter: '{value} ' + config.yAxis[0].suffix,
                    textStyle: {
                        color: '#919599'
                    }
                },
            ...
            },
            {
                ...
                // y轴标题
                name: config.yAxis[1].title,

                // 坐标轴的分割段数
                splitNumber: config.yAxis[1].splitNumber,
                ...
                // 坐标轴刻度标签的相关设置
                axisLabel: {
                    formatter: '{value} ' + config.yAxis[1].suffix,
                    textStyle: {
                        color: '#919599'
                    }
                },
